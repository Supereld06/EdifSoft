                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @foreach($expensa->recibos as $recibo)
                                    ...
                                    <a href="{{ route('recibos_estacionamientos.pdf', $recibo->id) }}" target="_blank"
                            ...
                            <td>
                                ...
                                <a href="{{ route('expensas_estacionamientos.edit', $expensa) }}"
                                ...
                                @if($expensa->recibos->count() == 0)
                                    ...
                                    <form action="{{ route('expensas_estacionamientos.destroy', $expensa) }}" method="POST"
                                ...
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('recibos_estacionamientos.store') }}" method="POST">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <input type="hidden" name="expensa_estacionamiento_id"
                                                value="{{ $expensa->id }}">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" readonly
                                                    value="{{ $expensa->estacionamiento->numero_estacionamiento }}">
                                        ...
                                        <input type="hidden" name="origen" value="estacionamientos">
